...
<body>
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            {{-- <li class="scroll-to-section"><a href="events" class="active">Home</a></li> --}}
                            {{-- <li><a href="events">Home</a></li> --}}
                            <li class="btn"><a href="/events">Home</a></li>
                            {{-- <li><a href="events">Perjalanan</a></li> --}}
    ...
    <section class="section main-banner" id="top" data-section="section1">
        ...
        <div class="row"><br>
            <div class="col-md-8 mt-3 mb-3 marginTop">
                <div class="col-sm-12">
                    <div id='calendar'></div>
                </div>
            </div>
            ...
            <div class="col-md-4 mt-3 mb-3 marginTop">
        ...
        {{-- <img src="{{ asset('storage\images\1687233704_Screenshot 2023-04-14 102026.png') }} " style="width:100%"> --}}
    </section>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <img src="{{ asset('storage\images\1687233704_Screenshot 2023-04-14 102026.png') }} "
                        style="width:100%">
